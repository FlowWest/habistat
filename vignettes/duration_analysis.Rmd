...
<mark>TODO: Add updated version of this chart incl. scaling</mark>
...
To capture only ecologically relevant time windows, we filter the hydrographs by relevant months for the salmonid run of interest: <mark>CITE?</mark>
...
![](figures/duration_plot_example.png)
