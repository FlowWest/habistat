...
```{r spawning_velocity_hsi, echo=FALSE, message=FALSE, warning=FALSE}
habistat::suitability_hsi_vel_spawning |>
  enframe() |>
  unnest(cols = value) |>
  filter(name != "max") |>
  ggplot(aes(x = vel_ft_s, y = hsi)) +
  ...
  xlab("Velocity (ft/sec)") +
  ggtitle("Velocity HSI as upper envelope of runs")
```
